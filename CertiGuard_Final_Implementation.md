...
Run the dashboard:  python certiguard/dashboard/server.py
Then re-run tests:  python tests/test_all_layers.py
Watch events appear live on http://localhost:5001
""")
```
